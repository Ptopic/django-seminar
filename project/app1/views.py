...
from .forms import DodajPredmetForm, DodajNovogStudenta, DodajNovogProfesora, DodijeliPredmetProfesour, DodijeliKaoNositelja, EditKorisnika
...
def viewPredmet(request, predmet_id):
    ...
    return render(request, 'predmet-stu-list.html', {'predmet':predmet, 'student_list': studentsForPredmet})
